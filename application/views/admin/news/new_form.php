      ...
      <div class="card-body">
          ...
          <form action="<?= base_url('admin/news/add') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm " id="date" name="date" value="<?= date('Y-m-d') ?>" readonly>
              </div>

              <div class="form-group">
                  <label for="name">Ringkasan</label>
                  <textarea class="form-control" id="short_content" rows="10" name="short_content"></textarea>
              </div>

              <div class="form-group">
                  <label for="name">Deskripsi Lengkap</label>
                  <textarea class="form-control" id="full_content" rows="10" name="full_content"></textarea>
              </div>
