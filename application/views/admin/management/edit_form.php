  ...
  <div class="card shadow mb-4">
      <div class="card-header py-3">
          <div class="d-flex justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Edit Management</h6>
              <div>
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" id="id_management_category" name="id_management_category">
                      <?php foreach ($categories as $key => $category) : ?>
                          <option value="<?= $category->id ?>" <?= ($category->id == $management->id_management_category) ? "selected" : "" ?>><?= $category->name ?></option>
                      <?php endforeach; ?>
                  </select>
              </div>
              <div class="form-group">
                  <label for="name">Nama</label>
                  <input type="text" class="form-control" id="name" name="name" value="<?= $management->name ?>">
              </div>

              <div class="form-group">
                  <label for="name">Tanggal Lahir</label>
                  <input type="text" class="form-control input-sm datepicker" id="birth_date" name="birth_date" value="<?= $management->birth_date ?>">
              </div>

              <div class="form-group">
                  <label for="image">Gambar</label>
                  <input type="file" class="form-control" id="image" name="image">
                  <input type="hidden" class="form-control" id="old_image" name="old_image" value="<?= $management->image ?>">
              </div>
