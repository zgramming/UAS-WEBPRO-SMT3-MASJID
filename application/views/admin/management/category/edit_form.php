  ...
  <div class="card shadow mb-4">
      <div class="card-header py-3">
          <div class="d-flex justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Edit Jabatan Management</h6>
              <div>
      ...
      <div class="card-body">
          ...
          <form action="<?= base_url('admin/updateCategoryManagement/' . $category->id) ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                  <label for="name">Nama</label>
                  <input type="text" class="form-control" id="name" placeholder="Ketua, Wakil,Sekretaris, dll... " name="name" value="<?= $category->name ?>">
              </div>
              <div class="form-group">
